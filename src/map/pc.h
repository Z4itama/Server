...
#define HATE_FEEL_COOLDOWN 900000
...
struct map_session_data {
	...
	struct {
		...
		unsigned ctf_active: 1;//0 not playing ctf, 1 playing. knx
	...
	unsigned int canuseygg_tick;	//Bruno
	unsigned int canuseyggwoe_tick;	// [Diego]
	...
	unsigned int warp_delay;//bruno
	
	unsigned int feel_cooldown_tick;//nuhuh
	unsigned int hate_cooldown_tick;//nuhuh
...
// knx: Arena Queues
	struct arena_fifo *my_are_fifo1;
	struct arena_fifo *my_are_fifo2;
	struct arena_fifo *my_are_fifo3;
