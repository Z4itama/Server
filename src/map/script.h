...
#define ARENA_QUEUE_MAX_LENGTH 300
#define ARENA_QUEUES 3

struct arena_fifo{
	struct arena_fifo *prev;
	struct arena_fifo *next;
	struct map_session_data *sd;
};
extern struct arena_fifo are_queue[ARENA_QUEUES][ARENA_QUEUE_MAX_LENGTH];
extern int are_queue_first_empty[ARENA_QUEUES];
extern struct arena_fifo *are_queue_first[ARENA_QUEUES];
extern struct arena_fifo *are_queue_last[ARENA_QUEUES];
extern int are_queue_length[ARENA_QUEUES];
//--end arena queues
